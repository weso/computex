...
object PREFIXES {
 ...
 lazy val cex_Mean				= resource("cex","Mean")
 lazy val cex_MeanBetweenMissing = resource("cex","MeanBetweenMissing")
 lazy val cex_Normalize			= resource("cex","Normalize")
 lazy val cex_Ranking			= resource("cex","Ranking")
 lazy val cex_WeightedMean	    = resource("cex","WeightedMean")
 lazy val cex_WeightedSimple    = resource("cex","WeightedSimple")
 ...
 lazy val sdmxConcept_obsStatus = property("sdmxConcept","obsStatus")
