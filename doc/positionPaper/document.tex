...
%		basicstyle=\ttfamily\fontsize{8}{8}\armenianfont,
%    tabsize=2,
...
\lstdefinestyle{sparql}{numberblanklines=true, 
    morekeywords={SELECT, FROM, WHERE, FILTER, GROUP BY, IN, AS, LIMIT,
    OFFSET,PREFIX,OPTIONAL,UNION,foaf,rdf,skos,rdfs,ex,xsd,owl,skosxl,doap,void,dbo}}

\lstdefinestyle{N3}{numberblanklines=true, morekeywords={foaf, prefix, rdf,
